...
public class TurfWar extends PApplet {
    ...
    class Player {
        ...
        int downKey;
        int rightKey;
        Player(int x, int y, int speed, int playerSizeX, int playerSizeY, int playerColor, int upKey, int leftKey, int downKey, int rightKey) {
        	this.x = x;
        	this.y = y;
        	this.speed = speed;
        ...
        void drawPlayer() {
             ...
             */
        	fill(playerColor);
            rect(x,y, playerSizeX, playerSizeY);
    ...
    public void setup() {
      ...
      background(99, 66, 9);
         ...
         *///x,y,speed,playerSizeX, playerSizeY, color, up, left, down, right
        
       player1 = new Player(70, 300, 10, 80, 130, new Color(210,10,173).getRGB(), UP,LEFT, DOWN, RIGHT);
       player2 = new Player(70, 101, 10, 80, 130, new Color(27, 245, 201).getRGB(), 87, 65, 83, 68);
    }
